...
const Login = () => {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-canvas dark:bg-canvas-dark px-4">
      <div className="absolute -top-40 -left-40 w-96 h-96 rounded-full bg-nova-500/20 blur-3xl" />
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="card p-7 animate-slide-up">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Sign in to continue to your workspace</p>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-6 text-center">
            ...
            <Link to="/register" className="text-nova-600 dark:text-nova-300 font-medium hover:underline">
              Create account
            </Link>
          </p>
        </div>
